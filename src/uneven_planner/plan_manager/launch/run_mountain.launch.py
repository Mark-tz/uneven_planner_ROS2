...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('map_name',   default_value='mountain'),
        DeclareLaunchArgument('x_pos',      default_value='1.0'),
        DeclareLaunchArgument('y_pos',      default_value='1.0'),
        DeclareLaunchArgument('z_pos',      default_value='2.0'),
        DeclareLaunchArgument('Y_pos',      default_value='3.14'),

        Node(
            package='plan_manager',
            executable='manager_node',
            name='manager_node',
            parameters=[ join(get_package_share_directory('plan_manager'), 'params', 'run_mountain.yaml') ],
            remappings=[
                ('cmd',  cmd_topic),
                ('odom', odom_topic),
                ('traj', traj_topic),
