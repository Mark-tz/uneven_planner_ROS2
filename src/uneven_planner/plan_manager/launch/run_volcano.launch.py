...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('map_name',   default_value='vocano'),
        DeclareLaunchArgument('x_pos',      default_value='-4.0'),
        DeclareLaunchArgument('y_pos',      default_value='0.4'),
        ...
        Node(
            ...
            name='manager_node',
            parameters=[ join(get_package_share_directory('plan_manager'), 'params', 'run_vocano.yaml') ],
            remappings=[
                ('cmd',  cmd_topic),
                ('odom', odom_topic),
                ('traj', traj_topic),
